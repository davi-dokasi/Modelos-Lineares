...
- ***car_run_km*** (Quilometragem):Para cada quilômetro adicional rodado, o preço do veículo aumenta em média 0.0001871 unidades monetárias, mantendo todas as outras variáveis constantes. Este coeficiente não é estatisticamente significativo (p-valor = 0.813).

- ***prod_year*** (Ano de produção): ara cada ano adicional de produção, o preço do veículo aumenta em média 2.676 unidades monetárias, mantendo todas as outras variáveis constantes. Este coeficiente não é estatisticamente significativo (p-valor = 0.402).
